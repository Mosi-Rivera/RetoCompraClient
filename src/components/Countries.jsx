    ...
    return (
        <>
            <FormControl error={props.error} fullWidth>
                <Select onChange={props.getCountry} value={props.value} fullWidth>
                ...
                {props.helperText && <FormHelperText>This field is required</FormHelperText>}
            </FormControl>
...
//             <MenuItem value={"FK"}>Falkland Islands (Islas Malvinas)</MenuItem>
...
//             <MenuItem value={"HM"}>Heard &amp; McDonald Islands</MenuItem>
